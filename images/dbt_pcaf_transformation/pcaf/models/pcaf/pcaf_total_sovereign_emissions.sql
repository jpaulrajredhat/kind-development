...
primap as (
    select prmp.*,
    0 as partial_consumption_value
...
cte_base as (
    select s.validity_date,
        ...
        cast(null as double) as scope2_value,
        cast(null as date) as scope2_date,
        cast(null as double) as scope3_value,
        cast(null as date) scope3_date,
        cast(null as double) exported_emissions_value,
        prmp.partial_consumption_value, -- to prevent errors, will later be taken from oecd
        --null as partial_consumption_value,
        w.population_value,
        case
